...
public class MemberServiceImpl implements MemberService , UserDetailsService {
    ...
    public Page<MemberDTO> memberList(String keyword, Pageable pageable){
        ...
        Page<Member> memberPage = memberRepository.memberList(keyword, pageable);
        /*DTO로 변환한다.*/
        Page<MemberDTO> memberDTOList = memberPage.map(member -> modelMapper.map(member,MemberDTO.class));
        /*리스폰스를 만든다.*/
